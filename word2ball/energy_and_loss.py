...
import random
import time
from word2ball.qsr_util import circles
from word2ball.qsr_util import qsr_part_of_characteristic_function, qsr_disconnect_characteristic_function, vec_length
from word2ball.colors import cnames

colorList = ['blue', 'green', 'red', 'cyan', 'magenta', 'yellow','black', 'seagreen', 'pink','navy','violet', 'crimson'] + list(cnames.keys())
